...
class Vgg19:
    def __init__(self, vgg19_npy_path=None):
        if vgg19_npy_path is None:
            ...
            path = os.path.join(path, "vgg19_trained.npy")
            vgg19_npy_path = path
    ...
    def build(self, rgb):
        ...
        self.conv6 = self.conv_layer(self.pool5, "conv6")
        self.conv7 = self.conv_layer(self.conv6, "conv7")
        self.pool6=self.avg_pool_end(self.conv7,"pool6")

        #self.fc8 = self.fc_layer(self.conv7, "fc8")
        #assert self.fc8.get_shape().as_list()[1:] == [64]
